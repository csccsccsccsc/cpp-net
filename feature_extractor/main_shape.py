...
from unet.unet_model_3layer import UNetStar as UNet
...
def run(data_path, n_rays, nc_in, nd_features, loss_scale, loss_type, init_lr=1e-4,):
    ...
    model = UNet(nc_in, nd_features)cuda()

    model_name='UNet2D_'+str(nd_features)+'d' + '_3layer'
...
if __name__ == '__main__':
    ...
    run(DATA_PATH, n_rays, args.n_rays + 1, nd_features, loss_names[args.loss_type], args.loss_type)